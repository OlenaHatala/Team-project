  ...
  return (
    <>
      <div className={classes.design}>
        ...
        <div className={classes['imagedesktop-wrapper']}>
          ...
          <div className={classes["text-block"]}>
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  makes a store without visible queues more attractive to new
                  customers
                </li>
              </ul>
            </p>
          ...
          <div className={classes["text-block"]}>
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  enables new revenue streams and improves an overall sales
                  process
                </li>
        ...
        <div className={classes.info}>
          ...
          <div className={classes["text-block"]}>
            ...
            <p>
              ...
              <ul>
                <li>
                  <span>minimize the customer’s perceived waiting time</span>
                </li>
                <li>reduce the number of complaints</li>
                <li>increase the retention rate</li>
                <li>
                  lead to a better service quality and higher customer
