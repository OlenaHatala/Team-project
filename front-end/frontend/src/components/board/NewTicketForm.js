...
const NewTicketForm = ({onClose}) => {
    ...
    const sumbitHandler = (e) => {
        ...
        setTickets((prevTickets)=>{
            ...
            let newTicketsDay = [];
            let newTicket =  { id: "id1_333" , type: 'ticket', date: new Date(`July 4 1776 ${time}`), duration};
    ...
    const newTicketModalContent = (
        ...
        <div className={classes.time}>
            <div className={classes["time-picker"]}>
                <h4>Weekday</h4>
                <select className={classes["picker-btn"]} 
                value={weekday} onChange={(e)=>{setWeekday(e.target.value)}}>
            ...
            <div className={classes["time-picker"]}>
                <h4>Time</h4>
                <input type="time" className={classes["picker-btn"]} 
            ...
            <div className={classes["time-picker"]}>
                <h4>Duration</h4>
                <input type="number" className={classes["picker-btn"]}
                value={duration} onChange={(e)=>{setDuration(e.target.value)}} />
            </div>
        </div>

        <div className={classes["item-checkbox"]}>
            <input type="checkbox" id="checkbox-text" className={classes["checkbox-text"]} 
        ...
        <div className={classes["buttons-container"]}>
            <div className={classes["button-inner"]}>
                <button type="button" className={classes["close-btn"]} onClick={onClose}>Cancel</button>
